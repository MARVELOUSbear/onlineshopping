...
<%@ page import="com.mysql.fabric.jdbc.FabricMySQLConnection"%>
<%
...
<html lang="en">
  <head>
    ...
    <title>My JSP 'my-address.jsp' starting page</title>
									...
									try{
										  ...
										  if(rs.next())
										  {
										    String Id = rs.getString(1);
										  	PreparedStatement pswl=con.prepareStatement("SELECT * FROM address_"+Id);
										  	ResultSet rswl= pswl.executeQuery();
										  	while (rswl.next()){
										    out.println("	<form action=\"/OnlineShopping/DeleteAddress\" method=\"POST\">");
											 out.println("<div class=\"col-xs-12 col-sm-6 col-md-4\">");
											 out.println("	<input type=\"hidden\" name=\"hidden\" value=\""+rswl.getString(1)+"\" />");
							                 out.println("       <div class=\"panel panel-default\">");
							                 out.println("           <div class=\"panel-heading\">");
							                 out.println("               <h3 class=\"panel-title\"><strong>"+rswl.getString(10)+"</strong></h3>");
							                 out.println("           </div>");
							                 out.println("           <div class=\"panel-body\">");
							                 out.println("               <ul>");
							                 out.println("                   <li><span class=\"address-name\"> <strong>"+rswl.getString(2)+"</strong></span></li>");
							                 out.println("                   <li><span class=\"address-company\">"+rswl.getString(3)+"</span></li>");
							                 out.println("                   <li><span class=\"address-line1\">"+rswl.getString(4)+"</span></li>");
							                 out.println("                   <li><span> <strong>Mobile</strong> :"+rswl.getString(9)+"</span></li>");
							                 out.println("               </ul>");
							                 out.println("           </div>");
							                 out.println("           <div class=\"panel-footer panel-footer-address\"><a href=\"add-address.html\"");
							                 out.println("                                                             class=\"btn btn-sm btn-success\"> <i class=\"fa fa-edit\"> </i> Edit </a>");
							                 out.println("             <button type=\"submit\" class=\"btn btn-sm btn-danger\"> <i class=\"fa fa-minus-circle\"></i> Delete </button></div>");
							                 out.println("       </div>");
							                 out.println("   </div>");
							                  out.println("</form>");
										  	HttpSession session1 = request.getSession(); 
											session1.setAttribute("loginid", Id);
										  	}
										  }
										  rs.close();
										  ps.close();
