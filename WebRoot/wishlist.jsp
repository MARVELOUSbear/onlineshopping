...
<html lang="en">
  <head>
    ...
    <title>My JSP 'wishlist.jsp' starting page</title>
									...
									try{
										  ...
										  if(rs.next())
										  {
										    String Id = rs.getString(1);
										  	PreparedStatement pswl=con.prepareStatement("SELECT * FROM wishlist_"+Id);
										  	ResultSet rswl= pswl.executeQuery();
										  	while (rswl.next()){
										  		out.println("	<form action=\"/OnlineShopping/DeleteWishlist\" method=\"POST\">");
										  		out.println("	<input type=\"hidden\" name=\"hidden\" value=\""+rswl.getString(1)+"\" />");
												out.println("	<tr class=\"CartProduct\">");
						                        out.println("   <td style=\"width:10%\" class=\"CartProductThumb\">");
						                        out.println("        <div><a href=\""+rswl.getString(6)+"\"><img src=\""+rswl.getString(5)+"\" alt=\"img\"></a></div>");
						                        out.println("    </td>");
						                        out.println("    <td style=\"width:40%\">");
						                        out.println("        <div class=\"CartDescription\">");
						                        out.println("            <h4><a href=\"product-details.html\">"+rswl.getString(2)+"</a></h4>");
						                        out.println("            <span class=\"size\">"+rswl.getString(3)+"</span>");
						                        out.println("            <div class=\"price\"><span>"+rswl.getString(4)+" Yuan</span></div>");
						                        out.println("        </div>");
						                        out.println("    </td>");
						                        out.println("    <td style=\"width:15%\">");
						                        out.println("     </td>");
						                        out.println("    <td style=\"width:40%\" class=\"delete\"><button type=\"submit\" class=\"btn   btn-primary\" onClick=\"\"><i class=\"glyphicon glyphicon-trash fa-2x\"></i> Delete</button></td>");
						                        out.println("</tr>");
						                        out.println("</form>");
